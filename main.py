...
class settings_screen:
    def __init__(self, master):
        ...
        self.first_theme_button = tk.Button(self.theme_frame)
        ...
        self.second_theme_button = tk.Button(self.theme_frame)
        ...
        self.third_theme_button = tk.Button(self.theme_frame)
